...
describe('AuthController', () => {
  ...
  describe('registerUser', () => {
    it('should register a new user', async () => {
      ...
      jest.spyOn(mockAuthService, 'register').mockResolvedValue(result as User);
  ...
  describe('blockToken', () => {
    it('should block a token', async () => {
      ...
      jest.spyOn(mockAuthService, 'blockToken').mockResolvedValue(true);
  ...
  describe('loginUserPassport', () => {
    it('should login a user using passport strategy', async () => {
