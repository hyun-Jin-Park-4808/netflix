...
describe('GenreService', () => {
  ...
  describe('findOne', () => {
    it('should return a single genre if found', async () => {
      const genre = {
        id: 1,
        name: 'Fantasy',
      };
  ...
  describe('update', () => {
    ...
    it('should throw a NotFoundException if genre ot update does not exist', () => {
      jest.spyOn(mockGenreRepository, 'findOne').mockResolvedValue(null);

      expect(service.update(1, { name: 'genre2' })).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('remove', () => {
    it('should remove a genre and return the id', async () => {
      const genre = {
        id: 1,
        name: 'genre',
      };
    ...
    it('should throw a NotFoundException if genre to delete does not exist', () => {
      jest.spyOn(mockGenreRepository, 'findOne').mockResolvedValue(null);
